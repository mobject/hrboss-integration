                        ...
                        <div class="post-body">
                            <p>
                                ...
                                <c:forEach var="entity" items="${hostedSP}">
                                    <a href="<c:url value="/hrboss//metadata/display"><c:param name="entityId" value="${hostedSP}"/></c:url>">
                            ...
                            <p>
                                ...
                                <c:forEach var="entity" items="${spList}">
                                    <a href="<c:url value="/hrboss//metadata/display"><c:param name="entityId" value="${entity}"/></c:url>">
                            ...
                            <p>
                                ...
                                <c:forEach var="entity" items="${metadata}" varStatus="status">
                                    <a href="<c:url value="/hrboss//metadata/provider"><c:param name="providerIndex" value="${status.index}"/></c:url>">
                                        <c:out value="${entity}"/></a><br/>
                                </c:forEach>
                                <c:if test="${empty metadata}"> - </c:if>
                            </p>
                            <div>
                            <form class="left" action="<c:url value="/hrboss//metadata/generate"/>" method="get">
                                <input type="submit" value="Generate new service provider metadata" class="button"/>
                            </form>
                            <form class="left" action="<c:url value="/hrboss//metadata/refresh"/>">
